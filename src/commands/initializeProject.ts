...
- 場所：「警視庁_特務_秘匿課」およびその秘匿課居室
- 時代：現代の日本
- 背景：この特務_秘匿課は、クトゥルフ神話や超常現象による大規模災害が発生しないように、まだ小規模の超常現象災害を処理する特務機関である。また、実は主人公（プレイヤー）を守り、支えるために存在している。捜査官は全員、主人公に強い敬意を抱いているが、その事実は主人公には秘密にされている。
`;
...
- 一人称：私
- 役職：課長
- 立場：警視庁_特務_秘匿課に配属された。自分自身が特別な権力を持つことには気づいていない。
`;
...
配属初日、「警視庁特務秘匿課」の居室に一つの女性が待っていた。彼女は警視庁特務秘匿課の秘書官クリス・アンダーだ。

「ジン課長、お待ちしておりました。私があなたの秘書を務めます、クリス・アンダーです。これから、お手続きと施設のご紹介をさせていただきますね」
`;
...
const WAKASA_SHIN_MD_CONTENT = `# キャラクター設定: 若狭 慎一郎
- 名前: 若狭 慎一郎
- 一人称：俺
- 性格: ノリが良くて、顔が美形。恋愛模様に興味なし。仕事熱心だが、趣味の幅が広い。
- 役職：捜査官
`;
...
const DEFAULT_CHARACTERS = [
    ...
    { fullName: '若狭 慎一郎', content: WAKASA_SHIN_MD_CONTENT },
];
